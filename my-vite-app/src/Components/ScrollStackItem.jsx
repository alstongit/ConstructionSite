...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    // Keep using window scroll position (unchanged)
    const scrollTop = window.scrollY;
    
    // Container position awareness (unchanged)
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      // Position calculations with container awareness (unchanged)
  ...
  useLayoutEffect(() => {
    ...
    // Connect Lenis scroll to our update function
    lenis.on('scroll', () => {
      updateCardTransforms();
    });
    ...
    // Keep window scroll listener as backup/fallback
    ...
    return () => {
      ...
      // Cleanup window scroll listener
  ...
  return (
    // Container structure remains unchanged
    <div
